window.ContextHubKernelConfig={debug:false,initializationTimeout:2000,stores:{emulators:{type:"granite.emulators",required:true},geolocation:{type:"contexthub.geolocation",required:true,config:{geocoder:{enabled:true}}},profile:{type:"granite.profile",required:true},surferinfo:{type:"contexthub.surferinfo",required:true},abandonedproducts:{type:"commerce.abandonedproducts",required:true},recentlyviewed:{type:"commerce.recentlyviewed",required:true},cart:{type:"commerce.cart",required:true},orderhistory:{type:"commerce.orderhistory",required:true},relatedproducts:{type:"commerce.relatedproducts",required:true},metadata:{type:"campaign.metadata",required:false},seeddata:{type:"campaign.seeddata",required:false},eventdata:{type:"aem.analyticsdata",required:true},pagedata:{type:"aem.pagedata",required:true},segmentation:{type:"aem.segmentation",required:true}}};
/*!
...
(function(){var a=function(){if(ContextHub.Utils.Cookie.exists("product_usertype")){return ContextHub.Utils.Cookie.getItem("product_usertype")=="broker"
}return false
};
ContextHub.SegmentEngine.ScriptManager.register("isProductUserTypeBroker",a);
var b=function(){if(ContextHub.Utils.Cookie.exists("product_usertype")){return ContextHub.Utils.Cookie.getItem("product_usertype")=="plansponsor"
}return false
};
ContextHub.SegmentEngine.ScriptManager.register("isProductUserTypePlanSponsor",b)
})();
